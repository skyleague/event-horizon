...
import type { SnsNotificationSchema, SnsRecordSchema } from '../../dev/aws/sns/sns.type.js'
import type {} from '../../dev/aws/sns/sns.type.js'
...
import type { SQSBatchHandler } from './types.js'
...
export function sqsBatchHandler<Configuration, Service extends DefaultServices | undefined, Profile, Payload, D>(
    definition: D & SQSBatchHandler<Configuration, Service, Profile, Payload>,
