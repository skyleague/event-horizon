...
export function createLogger(
    options: AwsLogger | ConstructorOptions = { serviceName, logFormatter: new LogFormatter() }
): Logger {
    const instance: AwsLogger = options instanceof AwsLogger ? options : new AwsLogger(options)
